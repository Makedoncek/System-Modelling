...
from task_2.process import Process as ProcessBank
from task_3.process import ProcessHospital as ProcessHospital
...
class Model:
    ...
    def print_result(self):
        ...
        for e in self.list:
            e.result()
            if isinstance(e, Process) or isinstance(e, ProcessBank) or isinstance(e, ProcessHospital):
                num_of_processors += 1
